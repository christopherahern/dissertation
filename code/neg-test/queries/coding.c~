...
1: {
    ...
    \3: (CMAYENBI*|CMEARLPS*|CMPOLYCH*|CMNTEST*|CMPURVEY*|CMEDVERN*|CMCTPARS*|CMCTMELI*|CMEQUATO*|CMBOETH*|CMOTEST*|CMCLOUD*|CMASTRO*|CMHILTON* inID)
    \4: (CMHORSE*|CMAELR3*|CMROLLTR*|CMROLLEP*|CMBRUT3*|CMWYCSER*|CMMANDEV*|CMBENRUL*|CMEDTHOR*|CMGAYTRY*|CMVICES4*|CMJULNOR*|CMROYAL*|CMMIRK*|CMTHORN*|CMEDMUND*|CMKEMPE*|CMCAPSER*|CMCAPCHR*|CMMALORY*|CMREYNES*|CMGREGOR*|CMREYNAR*|CMFITZJA*|CMINNOCE*|CMAELR4* inID)
    \5: (CMSIEGE* inID)
...
2: {
    ...
    \9: (*-179*|*-189*|*-199* inID)
   \1: (CMMIRK* inID)
    \2: (CMLAMBET*|CMTRINIT*|CMKENTHO*|CMSAWLES*|CMHALI*|CMKATHE*|CMJULIA*|CMMARGA*|CMBENRUL*|CMROYAL* inID)
    \3: (CMANCRIW*|CMEDMUND* inID)
    \4: (CMROLLTR*|CMGAYTRY*|CMTHORN* inID)
    \5: (CMPETERB*|CMEALRPS*|CMROLLEP*|CMHORSES*|CMAELR4*|CMKEMPE*|CMCAPSER*|CMEARLPS* inID)
    ...
    \9: (CMEDVERN*|CMCTPARS*|CMCTMELI*|CMEQUATO*|CMOTEST*|CMASTRO*|CMHILTON*|CMFITZJA*|CMINNOCE* inID)
     \0: (CMLAMB*|CMORM*|CMVICES1*|CMANCRIW*|CMAYENBI*|CMAELR3*|CMROLLTR*|CMEDTHOR*|CMROLLEP*|CMEDVERN*|CMCTPARS*|CMCTMELI*|CMBRUT3*|CMWYCSER*|CMBOETH*|CMMANDEV*|CMHORSES*|GMGAYTRY*|CMVICES4*|CMJULNOR*|CMTHORN*|CMMALORY*|CMSIEGE* inID)
...
3: {
   \0: (CMLAMB*|CMPETERB*|CMORM*|CMVICES1*|CMANCRIW*|CMAYENBI*|CMEARLPS*|CMAELR3*|CMROLLTR*|CMROLLEP*|CMEDVERN*|CMCTPARS*|CMCTMELI*|CMBRUT3*|CMWYCSER*|CMBOETH*|CMMANDEV*|CMHORSES*|CMEDTHORN*|CMGAYTRY*|CMVICES*|CMJULIAN*|CMTHORN*|CMAELRE4*|CMKEMPE*|CMMALORY*|CMSIEGE*|CMEDTHOR*|CMJULNOR* inID)
    \1: (CMASTRO*|CMREYNAR* inID)
    \2: (CMCLOUD*|CMEQUATO*|CMCAPSER* inID)
    \4: (CMCAPCHR* inID)
    \5: (CMLAMBET*|CMTRINIT*|CMKENTHO*|CMSAWLES*|CMHALI*|CMKATHE*|CMJULIA*|CMMARGA*|CMKENTSE*|CMOTEST*|CMBENRUL*|CMROYAL*|CMMIRK*|CMREYNES*|CMGREGOR*|CMFITZJA* inID)
    \6: (CMHILTON* inID)
...
/* Is the clause finite or not */
10: {
    finite: IP* idoms tensed_verb
    -: ELSE
}

/* Label pronouns and where they occur in the sentence */
11: {
	/*For just pronouns, but not reflexives: pronoun: IP* idoms NP-SBJ* AND NP-SBJ* idoms PRO */
	pronoun-subj: IP* idoms NP-SBJ* AND NP-SBJ* idoms PRO*
	pronoun-obj: IP* idoms NP-OB1*|NP-OB2*|NP-ACC*|NP-DAT* AND NP-OB1*|NP-OB2*|NP-ACC*|NP-DAT* idoms PRO*
	-: ELSE
}

/* Label demonstratives and where they occur in the sentence */
12: {
	demonst-subj: IP* idoms NP-SBJ* AND NP-SBJ* idoms D AND D idoms +tis|+tise|this|+tat|that|+tes|+tese|+tos|+tose|those
	demonst-obj: IP* idoms NP-OB1*|NP-OB2*|NP-ACC*|NP-DAT* AND NP-OB1*|NP-OB2*|NP-ACC*|NP-DAT* idoms D AND D idoms +tis|+tise|this|+tat|that|+tes|+tese|+tos|+tose|those
	-: ELSE
}

/* Label definites and where they occur in the sentence NOTE:+te is treated as a definite*/
13: {
	definite-subj: IP* idoms NP-SBJ* AND NP-SBJ* idoms D AND D idoms the|te|+te
	definite-obj:  IP* idoms NP-OB1*|NP-OB2*|NP-ACC*|NP-DAT* AND NP-OB1*|NP-OB2*|NP-ACC*|NP-DAT* idoms D AND D idoms the|te|+te
	-: ELSE
}

/* Label indefinites and where they occur in the sentence */
14: {
	indefinite-subj: IP* idoms NP-SBJ* AND NP-SBJ* idoms D AND D idoms a|an
	definite-obj:  IP* idoms NP-OB1*|NP-OB2*|NP-ACC*|NP-DAT* AND NP-OB1*|NP-OB2*|NP-ACC*|NP-DAT* idoms D AND D idoms a|an
	-: ELSE
}
