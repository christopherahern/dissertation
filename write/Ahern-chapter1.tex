...
%
%
%focussed on describing 
%
%
%
%in the generative tradition, the process of change has 
%
%focussed almost exclusively on characterizing how 
%
%orderly heterogeneity \citep{weinreich-labov-herzog1968, Labov:1972, Labov:1994}.
%
%
%The study of language change has often emphasized the role of acquisition 

%[A]ll this, de Saussure's \emph{la parole}, lies beyond the power of our science. We cannot predict whether a certain person will speak at a given moment, or what he will say, or in what words and other linguistic forms he will say it. Our science can deal only with those features of language, de Saussure's \emph{la langue}, which are common to all the speakers of a community, the phonemes, grammatical categories, lexicon, and so on.\\ --Leonard Bloomfield \citeyearpar[444]{bloomfield1927}
...
%In the most general sense acquisition is a function from some initial state of the learner and the linguistic environment to some terminal state. Where $G_0$ and $G$ represent the starting and terminal states, and $E$ represents the linguistic environment, this can be represented as follows.
%\begin{equation}
%	\mathcal{A}(G_0, E) \rightarrow G
%\end{equation}
%The end state of the process of acquisition is what is often characterized as \emph{grammatical competence} \citep{chomsky1980rules}.
%
%In parallel to this grammatical competence, speakers also have a  \emph{pragmatic competence} that ``underlies the ability to use [\emph{grammatical competence}] along with the conceptual system to achieve certain ends or purposes'' \citep[59]{chomsky1980rules}. We see the effect of this  pragmatic competence via use. In the most general sense, use is a function from the set of forms defined by grammatical competence to the linguistic environment. 
%
%\begin{equation}
%	\mathcal{U}(G) \rightarrow E
%\end{equation}
%That is, use determines how people put their grammatical knowledge to work, which in turn creates the linguistic environment. Note that the functional output of use serves as the input to acquisition and vice versa. If these functions characterize acquisition and use accurately, then we can ask what role they might play in the formal and functional cycles. 
