...
\def\mytitle{CYCLES AND STABILITY IN LINGUISTIC SIGNALING} % Make sure this is in all caps
\def\myauthor{Christopher Ahern}
\def\myauthorfull{Christopher Andrew Ahern}
\def\mysupervisorname{Robin Clark}
